...
void gauss(wide_stream* in_stream, wide_stream* out_stream, ap_uint<32> rows, ap_uint<32> cols, int sigma1, int sigma2){
...
#pragma HLS INTERFACE s_axilite port=sigma1 bundle=CONTROL_BUS offset=0x24 clock=AXI_LITE_clk
#pragma HLS INTERFACE s_axilite port=sigma2 bundle=CONTROL_BUS offset=0x2C clock=AXI_LITE_clk
#pragma HLS INTERFACE s_axilite port=return bundle=CONTROL_BUS clock=AXI_LITE_clk

#pragma HLS INTERFACE ap_stable port=rows
#pragma HLS INTERFACE ap_stable port=cols
#pragma HLS INTERFACE ap_stable port=sigma1
#pragma HLS INTERFACE ap_stable port=sigma2
...
#pragma HLS dataflow
	...
	hls::GaussianBlur<5,5>( src_bw, canny_edges, sigma1, sigma2 );
